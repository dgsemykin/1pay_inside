    ...
    1: [function (require, module, exports) {
      ...
      module.exports = function cyrillicToTranslit(config) {
        ...
        */
        ...
        var _reversedFirstLetters;

        if (_preset === "ru") {
          // Russian: i > always и, y > й in initial position, e > э in initial position
          _reversedFirstLetters = _objectSpread({}, invert(_firstLetters), {
            "i": "и",
            "": ""
          });
        } else if (_preset === "uk") {
        ...
        var _initialDigraphs = _preset === "ru" ? {
          "е": "ye"
        } : {
          "є": "ye",
          "ї": "yi"
        ...
        var _firstDigraphs = _objectSpread({}, _regularDigraphs, {}, _initialDigraphs);

        var _reversedFirstDigraphs = _objectSpread({}, invert(_firstDigraphs));

        var _firstAssociations = _objectSpread({}, _firstLetters, {}, _firstDigraphs);
        /*
        ASSOCIATIONS FOR NON-INITIAL POSITION
        */


        var _nonFirstLetters = _objectSpread({}, _firstLetters, {
          "й": "i"
        });
        ...
        var _reversedNonFirstLetters;

        if (_preset === "ru") {
          // Russian: i > always и, y > ы in non-initial position, e > е in non-initial position
          _reversedNonFirstLetters = _objectSpread({}, invert(_firstLetters), {}, {
            "i": "и",
            "y": "ы",
            "e": "е",
            "": ""
        ...
        var _nonFirstDigraphs = _objectSpread({}, _regularDigraphs, {}, _nonInitialDigraphs);

        var _reversedNonFirstDigraphs = _objectSpread({}, invert(_nonFirstDigraphs));

        var _nonFirstAssociations = _objectSpread({}, _nonFirstLetters, {}, _nonFirstDigraphs);
        ...
        function transform(input, spaceReplacement) {
          ...
          for (var i = 0; i < normalizedInput.length; i++) {
            var isUpperCaseOrWhatever = normalizedInput[i] === normalizedInput[i].toUpperCase();
            var strLowerCase = normalizedInput[i].toLowerCase();
        ...
        function reverse(input, spaceReplacement) {
          ...
          while (i < normalizedInput.length) {
            ...
            var newLetter = void 0;
            var digraph = normalizedInput.slice(i, i + 2).toLowerCase();
